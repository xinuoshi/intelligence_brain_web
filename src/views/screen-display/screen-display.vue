    ...
    <div class="flexRow screenDisplay">
        ...
        <div class="right flexColumn">
            <div class="rightAccident flexColumn">
                <div class="rightAccidentTitle"></div>
            ...
            <div class="rightCarLength flexColumn">
                ...
                <div class="flexRow Carbody">
                    ...
                    <div class="CarTable flexColumn">                         
                        <div v-for="(item,i) in carlistP" :key="i">
                            <el-tooltip class="item" effect="dark" :content="item.value+'%'" placement="top-end">
                                <div class="CarjdtBox"  :style="{'width':item.value+'%'}">
                                    <span class="Carjdt" :style="{'border-right':(i+1)+'px solid #0892d7'}"></span>
                                </div>
                            </el-tooltip>
                        </div>
...
<style>
    .leftPart .el-carousel__indicators{
        background: url(../../assets/svreenDisplay/rightHover.png)no-repeat 0 8px;
        top:30px !important;
        left:80%;
    }
    .leftPart .el-carousel__button {
    ...
    .areaPeed .el-carousel{
        flex:1;
        display: flex;
        flex-direction: column;
    }
    .areaPeed .el-carousel__arrow {
    ...
    .middleMapTitle{
        width: 100%;
        height: 90px;
        background: url(../../assets/svreenDisplay/title.png)no-repeat 0 25px;
...
export default {    
    ...
    methods: {
        ...
        dayYd() {
            ...
            let accidentList = [];
            for (let u = 0; u < 20; u++) {
                accidentList.push({id: u});
            }
            let accidentList2 = [];
            let accidentListSe = []
            for (let j in this.accidentList) {
                accidentListSe.push(
                    {
                        name:this.accidentList[j].name + this.accidentList[j].value + "起",
                        value: this.accidentList[j].value,
                        itemStyle: this.accidentList[j].itemStyle
                    }
                );
                accidentList2.push({
                    value:this.accidentList[j].value,
                    itemStyle:{color:"#4872c4"}
                });
            }
            let naturalOption = {
                legend: { 
