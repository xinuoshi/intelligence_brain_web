<template>
    <div class="maincss">
        <div style="height:83vh;padding: 0px 15px;margin-top: 5px">
            ...
            <div class="mianup">
                <div class="leftmokuai">
                    <div class="maintwo">
                        <div id="Columns1" class="zpEarchl" style="width: 100%;height:100%"></div>
                    </div>
                    <div class="mainthree">
                        <div id="Caketype1" class="zpEarchl" style="width: 48%;height:100%"></div>
                        <div id="Caketype2" class="zpEarchl" style="width: 48%;height:100%;margin-left: 2.5%"></div>
                    </div>
                    <div class="mainfour">
                        <div id="lineColumns1" class="zpEarchl" style="width: 48%;height:100%"></div>
    ...
    export default {
        ...
        methods : {
            ...
            async mainzhu(){
                ...
                let arry1 = this.resvalue.illegalDeductionRecordStatistic;
                let keys1 = [];
                let keysValue1 = [];
                let ownlist1 = [];
                for( let i in arry1){
            ...
            postval() {
                let val = new Promise(function (resolve, reject) {
                    console.log(portraitPerson.portraitPerson.data);
